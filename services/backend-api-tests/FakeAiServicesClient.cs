...
// AIS-03/04/07: a real HTTP call to services/ai-services isn't available in unit tests
// (no Docker/network dependency), so controller tests configure canned responses here
// instead of hitting the real self-hosted service.
